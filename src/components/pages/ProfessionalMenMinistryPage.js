...
import { 
  ...
  Lightbulb, ArrowForward, Email, Phone, Event, SportsSoccer, Handyman
...
const HeroBanner = styled(Box)(({ theme }) => ({
  ...
  '&::before': {
    ...
    background: 'url(/images/banner/men-banner.JPG)',
...
const ActivityCard = styled(Card)(({ theme, index }) => ({
  ...
  '&:hover': {
    ...
    boxShadow: '0 20px 40px -12px rgba(255, 152, 0, 0.25)',
  },
}));
          ...
          <Slide direction="up" in={visibleSections.has(0)} timeout={600}>
            <Box>
              ...
              <Typography variant="h6" color="text.secondary" sx={{
                ...
                We're building strong men of faith who lead courageously at home, work, and in their communities.
                Join us as we grow together in God's strength and purpose.
              </Typography>
            </Box>
          </Slide>
        </Box>
                ...
                {schedule.map((item, index) => (
                  <Grid item xs={12} md={6} key={index}>
                    <Paper elevation={4} sx={{
                      ...
                      border: '1px solid rgba(255, 152, 0, 0.1)', borderRadius: 16,
