                ...
                <div id="banner-slide" className="rev_slider fullwidthabanner" data-version="5.3.0.2">
                    ...
                    {/* <!-- SLIDE 3 --> */}
                        <li data-index="rs-3049" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">                        
                            ...
                            {/* <!-- MAIN IMAGE --> */}
                            <img src="images/slides/Church.jpg"  alt=""  data-bgposition="center center" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" className="rev-slidebg" data-no-retina />
                            {/* <!-- LAYERS --> */}
                            ...
                            <Link to="/watch-online" target="_self" className="tp-caption flat-button-slider bg-blue"
                            ...
                            data-width="['auto']"
                            data-height="['auto']">Watch Online
                            </Link>
                            {/* <!-- END LAYER LINK --> */}

                            <Link to="/services-v1" onClick={() => {window.location.href="/services-v1"}} title="" target="_self" className="tp-caption flat-button-slider bg-transparent"
                            ...
                            data-fontsize="['14',14','14','14']"
                            data-width="['auto']"
                            data-height="['auto']">Plan your visit
                            </Link>
                            {/* <!-- END LAYER LINK --> */}
                        </li>
                        ...
                        <li data-index="rs-3048" data-transition="slideremovedown" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"    data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">                        
                            ...
                            <Link to="/services-v1" onClick={() => {window.location.href="/services-v1"}} target="_self" className="tp-caption flat-button-slider bg-transparent"
