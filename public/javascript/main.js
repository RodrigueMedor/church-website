   ...
   'use strict'
                ...
                submitHandler: function( form ) {
                    ...
                    $.ajax({
                        ...
                        success: function( msg ) {
                            var result, cls;                            
                            if ( msg === 'Success' ) {result = 'Message Sent Successfully To Email Administrator. ' +
                                '( You can change the email management a very easy way to get the message of customers in the user manual )'; cls = 'msg-success';
                            } else {result = 'Error sending email.'; cls = 'msg-error'; } $form.prepend(
                                $('<div />', {
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        ...
        if(retina) {
            $('.logo').find('img').attr( {src:'./images/Logo.png',width:'161',height:'46'} );
        }
    };       
